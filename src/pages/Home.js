        ...
        <div className="Project-Description">
          <div className="Main-Description-1">
            <div>
              ...
              <div className="Main-Description-Contents">
                <p>
                  Cookiedog is a new generation of pop culture community that
                  live on the blockchain. They are fully interactive and evolve
                  over time unlocking new capabilities, games, and experiences –
                  and because they're NFTs, they're truly 100% yours.
                </p>
              </div>
            </div>
            <img
            ...
            <div>
              ...
              <div className="Main-Description-Contents">
                <p>
                  ...
                  <br></br>Every seoson you can buy limited version of cookies
                  nft of<br></br>cookiedog. and enjoy make expansion of piece of
          ...
          <div className="Main-Description-3">
            <div>
              ...
              <div className="Main-Description-Contents">
                <p>
                  If you take heart candy, you can access cookiedog universe.
                  You can create you can be architect for coasis. just take the
                  heart candy and join our membership.
                </p>
                ...
                <div className="Description-No">
                  <p>
                    ...
                    discord id. We will send you the heartcandy, and give you
                    the membership roll
                  </p>
                  <form>
                    <input
